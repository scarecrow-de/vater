                ...
                float               scale)
{
  ...
  mode_specs_str = getenv ("VATER_DEBUG_DUMMY_MODE_SPECS");
...
meta_monitor_manager_dummy_read_current (MetaMonitorManager *manager)
{
   ...
   *
   * VATER_DEBUG_NUM_DUMMY_MONITORS
   *
   ...
   *
   * VATER_DEBUG_NUM_DUMMY_MONITORS=2
   * VATER_DEBUG_DUMMY_MONITOR_SCALES=1,2
   * VATER_DEBUG_TILED_DUMMY_MONITORS=1
   */
  num_monitors_str = getenv ("VATER_DEBUG_NUM_DUMMY_MONITORS");
  if (num_monitors_str)
    {
  ...
  monitor_scales_str = getenv ("VATER_DEBUG_DUMMY_MONITOR_SCALES");
  ...
  tiled_monitors_str = g_getenv ("VATER_DEBUG_TILED_DUMMY_MONITORS");
...
meta_monitor_manager_dummy_constructed (GObject *object)
{
  ...
  nested_offscreen_transform =
    g_getenv ("VATER_DEBUG_NESTED_OFFSCREEN_TRANSFORM");
